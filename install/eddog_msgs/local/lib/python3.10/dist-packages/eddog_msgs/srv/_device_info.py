...
class Metaclass_DeviceInfo_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('eddog_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_DeviceInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eddog_msgs.srv import _device_info
...
class DeviceInfo(metaclass=Metaclass_DeviceInfo):
    from eddog_msgs.srv._device_info import DeviceInfo_Request as Request
    from eddog_msgs.srv._device_info import DeviceInfo_Response as Response
