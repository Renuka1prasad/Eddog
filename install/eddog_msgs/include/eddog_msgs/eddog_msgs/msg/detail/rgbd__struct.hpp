...
#ifndef EDDOG_MSGS__MSG__DETAIL__RGBD__STRUCT_HPP_
#define EDDOG_MSGS__MSG__DETAIL__RGBD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__eddog_msgs__msg__RGBD __attribute__((deprecated))
#else
# define DEPRECATED__eddog_msgs__msg__RGBD __declspec(deprecated)
#endif
...
struct RGBD_
{
  ...
  // pointer types
  using RawPtr =
    eddog_msgs::msg::RGBD_<ContainerAllocator> *;
  using ConstRawPtr =
    const eddog_msgs::msg::RGBD_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      eddog_msgs::msg::RGBD_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__eddog_msgs__msg__RGBD
    std::shared_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__eddog_msgs__msg__RGBD
    std::shared_ptr<eddog_msgs::msg::RGBD_<ContainerAllocator> const>
...
using RGBD =
  eddog_msgs::msg::RGBD_<std::allocator<void>>;
...
#endif  // EDDOG_MSGS__MSG__DETAIL__RGBD__STRUCT_HPP_
