...
{
  new (message_memory) eddog_msgs::msg::IMUInfo(_init);
}

void IMUInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::IMUInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUInfo_message_member_array[4] = {
  {
    ...
    offsetof(eddog_msgs::msg::IMUInfo, header),  // bytes offset in struct
  ...
  },
  {
    ...
    12,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::IMUInfo, data),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::IMUInfo, noise_variances),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::IMUInfo, bias_variances),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<eddog_msgs::msg::IMUInfo>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::IMUInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, IMUInfo)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::IMUInfo_message_type_support_handle;
}
