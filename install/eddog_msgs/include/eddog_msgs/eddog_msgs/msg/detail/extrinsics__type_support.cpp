...
{
  new (message_memory) eddog_msgs::msg::Extrinsics(_init);
}

void Extrinsics_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::Extrinsics *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Extrinsics_message_member_array[2] = {
  {
    ...
    offsetof(eddog_msgs::msg::Extrinsics, rotation),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Extrinsics, translation),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Extrinsics_message_members = {
  ...
  2,  // number of fields
  sizeof(eddog_msgs::msg::Extrinsics),
...
get_message_type_support_handle<eddog_msgs::msg::Extrinsics>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Extrinsics_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, Extrinsics)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Extrinsics_message_type_support_handle;
}
