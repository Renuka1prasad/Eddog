...
#ifndef EDDOG_MSGS__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
#define EDDOG_MSGS__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__eddog_msgs__msg__IMUInfo __attribute__((deprecated))
#else
# define DEPRECATED__eddog_msgs__msg__IMUInfo __declspec(deprecated)
#endif
...
struct IMUInfo_
{
  ...
  // pointer types
  using RawPtr =
    eddog_msgs::msg::IMUInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const eddog_msgs::msg::IMUInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      eddog_msgs::msg::IMUInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__eddog_msgs__msg__IMUInfo
    std::shared_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__eddog_msgs__msg__IMUInfo
    std::shared_ptr<eddog_msgs::msg::IMUInfo_<ContainerAllocator> const>
...
using IMUInfo =
  eddog_msgs::msg::IMUInfo_<std::allocator<void>>;
...
#endif  // EDDOG_MSGS__MSG__DETAIL__IMU_INFO__STRUCT_HPP_
