...
#ifndef EDDOG_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
#define EDDOG_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const eddog_msgs::msg::IMUInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const eddog_msgs::msg::IMUInfo & msg)
{
  return eddog_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<eddog_msgs::msg::IMUInfo>()
{
  return "eddog_msgs::msg::IMUInfo";
}

template<>
inline const char * name<eddog_msgs::msg::IMUInfo>()
{
  return "eddog_msgs/msg/IMUInfo";
}

template<>
struct has_fixed_size<eddog_msgs::msg::IMUInfo>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<eddog_msgs::msg::IMUInfo>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<eddog_msgs::msg::IMUInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // EDDOG_MSGS__MSG__DETAIL__IMU_INFO__TRAITS_HPP_
