...
{
  new (message_memory) eddog_msgs::msg::Geometry(_init);
}

void Geometry_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::Geometry *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Geometry_message_member_array[5] = {
  {
    ...
    offsetof(eddog_msgs::msg::Geometry, fr),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Geometry, fl),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Geometry, br),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Geometry, bl),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Geometry, euler_ang),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Geometry_message_members = {
  "eddog_msgs::msg",  // message namespace
  "Geometry",  // message name
  5,  // number of fields
  sizeof(eddog_msgs::msg::Geometry),
...
get_message_type_support_handle<eddog_msgs::msg::Geometry>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Geometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, Geometry)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Geometry_message_type_support_handle;
}
