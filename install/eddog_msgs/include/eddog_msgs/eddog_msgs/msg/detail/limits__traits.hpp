...
#ifndef EDDOG_MSGS__MSG__DETAIL__LIMITS__TRAITS_HPP_
#define EDDOG_MSGS__MSG__DETAIL__LIMITS__TRAITS_HPP_
...
inline void to_yaml(
  const eddog_msgs::msg::Limits & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const eddog_msgs::msg::Limits & msg)
{
  return eddog_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<eddog_msgs::msg::Limits>()
{
  return "eddog_msgs::msg::Limits";
}

template<>
inline const char * name<eddog_msgs::msg::Limits>()
{
  return "eddog_msgs/msg/Limits";
}

template<>
struct has_fixed_size<eddog_msgs::msg::Limits>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<eddog_msgs::msg::Limits>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<eddog_msgs::msg::Limits>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // EDDOG_MSGS__MSG__DETAIL__LIMITS__TRAITS_HPP_
