...
#ifndef EDDOG_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
#define EDDOG_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
...
inline void to_yaml(
  const eddog_msgs::msg::JoyCtrlCmds & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const eddog_msgs::msg::JoyCtrlCmds & msg)
{
  return eddog_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<eddog_msgs::msg::JoyCtrlCmds>()
{
  return "eddog_msgs::msg::JoyCtrlCmds";
}

template<>
inline const char * name<eddog_msgs::msg::JoyCtrlCmds>()
{
  return "eddog_msgs/msg/JoyCtrlCmds";
}

template<>
struct has_fixed_size<eddog_msgs::msg::JoyCtrlCmds>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Pose>::value && has_fixed_size<geometry_msgs::msg::Vector3>::value> {};

template<>
struct has_bounded_size<eddog_msgs::msg::JoyCtrlCmds>
...
template<>
struct is_message<eddog_msgs::msg::JoyCtrlCmds>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // EDDOG_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
