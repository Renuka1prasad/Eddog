...
{
  new (message_memory) eddog_msgs::msg::JoyCtrlCmds(_init);
}

void JoyCtrlCmds_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::JoyCtrlCmds *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JoyCtrlCmds_message_member_array[4] = {
  {
    ...
    offsetof(eddog_msgs::msg::JoyCtrlCmds, states),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::JoyCtrlCmds, gait_type),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::JoyCtrlCmds, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::JoyCtrlCmds, gait_step),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JoyCtrlCmds_message_members = {
  ...
  4,  // number of fields
  sizeof(eddog_msgs::msg::JoyCtrlCmds),
...
get_message_type_support_handle<eddog_msgs::msg::JoyCtrlCmds>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::JoyCtrlCmds_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, JoyCtrlCmds)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::JoyCtrlCmds_message_type_support_handle;
}
