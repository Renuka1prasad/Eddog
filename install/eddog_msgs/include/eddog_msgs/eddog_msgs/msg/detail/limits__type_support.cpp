...
{
  new (message_memory) eddog_msgs::msg::Limits(_init);
}

void Limits_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::Limits *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Limits_message_member_array[3] = {
  {
    ...
    offsetof(eddog_msgs::msg::Limits, eular_ang_range),  // bytes offset in struct
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Limits, height_range),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Limits, steplength_range),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Limits_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, Limits)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Limits_message_type_support_handle;
}
