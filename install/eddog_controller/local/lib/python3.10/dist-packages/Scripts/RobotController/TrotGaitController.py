...
import numpy as np
import rclpy
from Scripts.RobotController.GaitController import GaitController
from Scripts.RobotController.PIDController import PIDController
from Scripts.RoboticsUtilities.Transformations import rotxyz, rotz
...
class TrotGaitController(GaitController):
    def __init__(self, default_stance, stance_time, swing_time, time_step, use_imu):
        ...
        #                                     kp    ki    kd
        self.pid_controller = PIDController(0.15, 0.02, 0.002)
