...
import rclpy
import numpy as np
from Scripts.RoboticsUtilities.Transformations import rotxyz
from Scripts.RobotController.PIDController import PIDController
...
class RestController(object):
    def __init__(self, default_stance):
        ...
        #                                     kp     ki    kd
        self.pid_controller = PIDController(0.75, 2.29, 0.0)
        self.use_imu = False
    ...
    def updateStateCommand(self, msg, state, command):
        ...
        if self.use_button:
            if msg.buttons[7]:
                ...
                # self.get_logger().info(f"Rest Controller - Use roll/pitch compensation: {self.use_imu}")
