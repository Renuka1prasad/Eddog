...
from Scripts.RoboticsUtilities.Transformations import homog_transform_inverse, homog_transform
...
class InverseKinematics(object):
    ...
    def get_local_positions(self, leg_positions, dx, dy, dz, roll, pitch, yaw):
        ...
        print(pos_FR[:3], pos_FL[:3], pos_RR[:3], pos_RL[:3])
        print()
        print()
    ...
    def inverse_kinematics(self, leg_positions, dx, dy, dz, roll, pitch, yaw):
        ...
        for i in range(4):
            ...
            if D > 1.0:
                ...
                sqrt_term = sqrt(1 - D**2)
                theta4 = -atan2(sqrt_term, D)
