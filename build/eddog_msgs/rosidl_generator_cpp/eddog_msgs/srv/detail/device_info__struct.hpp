...
#ifndef EDDOG_MSGS__SRV__DETAIL__DEVICE_INFO__STRUCT_HPP_
#define EDDOG_MSGS__SRV__DETAIL__DEVICE_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__eddog_msgs__srv__DeviceInfo_Request __attribute__((deprecated))
#else
# define DEPRECATED__eddog_msgs__srv__DeviceInfo_Request __declspec(deprecated)
#endif
...
struct DeviceInfo_Request_
{
  ...
  // pointer types
  using RawPtr =
    eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__eddog_msgs__srv__DeviceInfo_Request
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__eddog_msgs__srv__DeviceInfo_Request
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Request_<ContainerAllocator> const>
...
using DeviceInfo_Request =
  eddog_msgs::srv::DeviceInfo_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__eddog_msgs__srv__DeviceInfo_Response __attribute__((deprecated))
#else
# define DEPRECATED__eddog_msgs__srv__DeviceInfo_Response __declspec(deprecated)
#endif
...
struct DeviceInfo_Response_
{
  ...
  // pointer types
  using RawPtr =
    eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__eddog_msgs__srv__DeviceInfo_Response
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__eddog_msgs__srv__DeviceInfo_Response
    std::shared_ptr<eddog_msgs::srv::DeviceInfo_Response_<ContainerAllocator> const>
...
using DeviceInfo_Response =
  eddog_msgs::srv::DeviceInfo_Response_<std::allocator<void>>;
...
struct DeviceInfo
{
  using Request = eddog_msgs::srv::DeviceInfo_Request;
  using Response = eddog_msgs::srv::DeviceInfo_Response;
};
...
#endif  // EDDOG_MSGS__SRV__DETAIL__DEVICE_INFO__STRUCT_HPP_
