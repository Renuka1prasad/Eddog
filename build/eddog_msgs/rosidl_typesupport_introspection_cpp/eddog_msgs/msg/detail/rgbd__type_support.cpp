...
{
  new (message_memory) eddog_msgs::msg::RGBD(_init);
}

void RGBD_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::RGBD *>(message_memory);
  typed_message->~RGBD();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RGBD_message_member_array[5] = {
  {
    ...
    offsetof(eddog_msgs::msg::RGBD, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::RGBD, rgb_camera_info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::RGBD, depth_camera_info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::RGBD, rgb),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::RGBD, depth),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<eddog_msgs::msg::RGBD>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::RGBD_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, RGBD)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::RGBD_message_type_support_handle;
}
