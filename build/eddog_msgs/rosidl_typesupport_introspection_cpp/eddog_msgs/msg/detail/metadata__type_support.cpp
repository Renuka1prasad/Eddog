...
{
  new (message_memory) eddog_msgs::msg::Metadata(_init);
}

void Metadata_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eddog_msgs::msg::Metadata *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Metadata_message_member_array[2] = {
  {
    ...
    offsetof(eddog_msgs::msg::Metadata, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eddog_msgs::msg::Metadata, json_data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Metadata_message_members = {
  ...
  2,  // number of fields
  sizeof(eddog_msgs::msg::Metadata),
...
get_message_type_support_handle<eddog_msgs::msg::Metadata>()
{
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Metadata_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, Metadata)() {
  return &::eddog_msgs::msg::rosidl_typesupport_introspection_cpp::Metadata_message_type_support_handle;
}
