...
static const _RGBD_type_support_symbol_names_t _RGBD_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, msg, RGBD)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eddog_msgs, msg, RGBD)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, eddog_msgs, msg, RGBD)() {
  return &::eddog_msgs::msg::rosidl_typesupport_c::RGBD_message_type_support_handle;
}
