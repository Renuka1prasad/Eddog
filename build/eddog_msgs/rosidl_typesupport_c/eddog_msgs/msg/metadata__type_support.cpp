...
static const _Metadata_type_support_symbol_names_t _Metadata_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, msg, Metadata)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eddog_msgs, msg, Metadata)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, eddog_msgs, msg, Metadata)() {
  return &::eddog_msgs::msg::rosidl_typesupport_c::Metadata_message_type_support_handle;
}
