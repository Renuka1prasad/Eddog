...
static const _Geometry_type_support_symbol_names_t _Geometry_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eddog_msgs, msg, Geometry)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, Geometry)),
  }
};
...
{
  return &::eddog_msgs::msg::rosidl_typesupport_cpp::Geometry_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eddog_msgs, msg, Geometry)() {
  return get_message_type_support_handle<eddog_msgs::msg::Geometry>();
}
