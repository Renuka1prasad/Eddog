...
static const _RGBD_type_support_symbol_names_t _RGBD_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eddog_msgs, msg, RGBD)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eddog_msgs, msg, RGBD)),
  }
};
...
{
  return &::eddog_msgs::msg::rosidl_typesupport_cpp::RGBD_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eddog_msgs, msg, RGBD)() {
  return get_message_type_support_handle<eddog_msgs::msg::RGBD>();
}
