...
bool eddog_msgs__msg__geometry__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.msg._geometry.Geometry", full_classname_dest, 33) == 0);
  }
  eddog_msgs__msg__Geometry * ros_message = _ros_message;
  {  // fr
...
PyObject * eddog_msgs__msg__geometry__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eddog_msgs.msg._geometry");
