...
bool eddog_msgs__msg__limits__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.msg._limits.Limits", full_classname_dest, 29) == 0);
  }
  eddog_msgs__msg__Limits * ros_message = _ros_message;
  {  // eular_ang_range
...
PyObject * eddog_msgs__msg__limits__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eddog_msgs.msg._limits");
