...
bool eddog_msgs__srv__device_info__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.srv._device_info.DeviceInfo_Request", full_classname_dest, 46) == 0);
  }
  eddog_msgs__srv__DeviceInfo_Request * ros_message = _ros_message;
...
PyObject * eddog_msgs__srv__device_info__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eddog_msgs.srv._device_info");
...
ROSIDL_GENERATOR_C_EXPORT
bool eddog_msgs__srv__device_info__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.srv._device_info.DeviceInfo_Response", full_classname_dest, 47) == 0);
  }
  eddog_msgs__srv__DeviceInfo_Response * ros_message = _ros_message;
  {  // device_name
