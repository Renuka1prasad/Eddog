...
#include "eddog_msgs/msg/detail/extrinsics__rosidl_typesupport_fastrtps_c.h"
...
using _Extrinsics__ros_msg_type = eddog_msgs__msg__Extrinsics;
...
size_t get_serialized_size_eddog_msgs__msg__Extrinsics(
  const void * untyped_ros_message,
...
static uint32_t _Extrinsics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eddog_msgs__msg__Extrinsics(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eddog_msgs
size_t max_serialized_size_eddog_msgs__msg__Extrinsics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs__msg__Extrinsics;
    is_plain =
      (
...
static size_t _Extrinsics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eddog_msgs__msg__Extrinsics(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, msg, Extrinsics)() {
