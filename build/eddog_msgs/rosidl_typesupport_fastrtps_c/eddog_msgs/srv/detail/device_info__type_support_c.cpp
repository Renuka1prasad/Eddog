...
#include "eddog_msgs/srv/detail/device_info__rosidl_typesupport_fastrtps_c.h"
...
#include "eddog_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _DeviceInfo_Request__ros_msg_type = eddog_msgs__srv__DeviceInfo_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eddog_msgs
size_t get_serialized_size_eddog_msgs__srv__DeviceInfo_Request(
  const void * untyped_ros_message,
...
static uint32_t _DeviceInfo_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eddog_msgs__srv__DeviceInfo_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eddog_msgs
size_t max_serialized_size_eddog_msgs__srv__DeviceInfo_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs__srv__DeviceInfo_Request;
    is_plain =
      (
...
static size_t _DeviceInfo_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eddog_msgs__srv__DeviceInfo_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, srv, DeviceInfo_Request)() {
...
using _DeviceInfo_Response__ros_msg_type = eddog_msgs__srv__DeviceInfo_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eddog_msgs
size_t get_serialized_size_eddog_msgs__srv__DeviceInfo_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DeviceInfo_Response__ros_msg_type * ros_message = static_cast<const _DeviceInfo_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_eddog_msgs__srv__DeviceInfo_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eddog_msgs
size_t max_serialized_size_eddog_msgs__srv__DeviceInfo_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eddog_msgs__srv__DeviceInfo_Response;
    is_plain =
      (
...
static size_t _DeviceInfo_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eddog_msgs__srv__DeviceInfo_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, srv, DeviceInfo_Response)() {
...
// already included above
// #include "eddog_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "eddog_msgs/srv/device_info.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eddog_msgs, srv, DeviceInfo)() {
