...
#include "eddog_msgs/msg/detail/joy_ctrl_cmds__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eddog_msgs::msg::JoyCtrlCmds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eddog_msgs::msg::JoyCtrlCmds & ros_message)
{
  // Member: states
  {
    cdr >> ros_message.states;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs::msg::JoyCtrlCmds;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::msg::JoyCtrlCmds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eddog_msgs::msg::JoyCtrlCmds *>(
    untyped_ros_message);
...
{
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_JoyCtrlCmds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eddog_msgs, msg, JoyCtrlCmds)() {
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_JoyCtrlCmds__handle;
}
