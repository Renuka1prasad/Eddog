...
#include "eddog_msgs/msg/detail/extrinsics__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eddog_msgs::msg::Extrinsics & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eddog_msgs::msg::Extrinsics & ros_message)
{
  // Member: rotation
  {
    cdr >> ros_message.rotation;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs::msg::Extrinsics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::msg::Extrinsics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eddog_msgs::msg::Extrinsics *>(
    untyped_ros_message);
...
{
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_Extrinsics__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eddog_msgs, msg, Extrinsics)() {
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_Extrinsics__handle;
}
