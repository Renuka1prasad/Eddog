...
#include "eddog_msgs/msg/detail/metadata__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eddog_msgs::msg::Metadata & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eddog_msgs::msg::Metadata & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs::msg::Metadata;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::msg::Metadata *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eddog_msgs::msg::Metadata *>(
    untyped_ros_message);
...
{
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eddog_msgs, msg, Metadata)() {
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_Metadata__handle;
}
