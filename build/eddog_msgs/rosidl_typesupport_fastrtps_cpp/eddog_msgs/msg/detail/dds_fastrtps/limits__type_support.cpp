...
#include "eddog_msgs/msg/detail/limits__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs::msg::Limits;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eddog_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  return &eddog_msgs::msg::typesupport_fastrtps_cpp::_Limits__handle;
}
