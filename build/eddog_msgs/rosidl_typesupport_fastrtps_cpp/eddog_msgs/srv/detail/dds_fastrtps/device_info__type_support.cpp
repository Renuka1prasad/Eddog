...
#include "eddog_msgs/srv/detail/device_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eddog_msgs::srv::DeviceInfo_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eddog_msgs::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_eddog_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<eddog_msgs::srv::DeviceInfo_Request>()
{
  return &eddog_msgs::srv::typesupport_fastrtps_cpp::_DeviceInfo_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eddog_msgs::srv::DeviceInfo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eddog_msgs::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<eddog_msgs::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &eddog_msgs::srv::typesupport_fastrtps_cpp::_DeviceInfo_Response__handle;
}
...
{
  return &eddog_msgs::srv::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
