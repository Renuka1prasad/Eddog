...
bool eddog_msgs__msg__rgbd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.msg._rgbd.RGBD", full_classname_dest, 25) == 0);
  }
  eddog_msgs__msg__RGBD * ros_message = _ros_message;
  {  // header
...
PyObject * eddog_msgs__msg__rgbd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eddog_msgs.msg._rgbd");
