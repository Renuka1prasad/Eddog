...
bool eddog_msgs__msg__joy_ctrl_cmds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eddog_msgs.msg._joy_ctrl_cmds.JoyCtrlCmds", full_classname_dest, 41) == 0);
  }
  eddog_msgs__msg__JoyCtrlCmds * ros_message = _ros_message;
  {  // states
...
PyObject * eddog_msgs__msg__joy_ctrl_cmds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eddog_msgs.msg._joy_ctrl_cmds");
